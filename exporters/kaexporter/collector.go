...
func (e *KAExporter) Describe(ch chan<- *prometheus.Desc) {
	...
	e.releaseValidationDuration.Describe(ch)
	e.releasePipelineExecutionDuration.Describe(ch)
...
func (e *KAExporter) Collect(ch chan<- prometheus.Metric) {
	...
	e.releaseValidationDuration.Collect(ch)
	e.releasePipelineExecutionDuration.Collect(ch)
